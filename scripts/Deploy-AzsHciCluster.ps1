...
$sleep = 10
while (((Get-DscLocalConfigurationManager -CimSession $cimSession | Select-Object -ExpandProperty lcmstate) -contains "busy" -or (Get-DscLocalConfigurationManager -CimSession $cimSession | Select-Object -ExpandProperty lcmstate) -contains "PendingConfiguration"))
{
...
Prepare-AzsHciClusterforAksHciDeployment

break

Cleanup-VMs -AzureStackHciHostVMs -RedeployDeletedVMs -WindowsAdminCenterVM
Cleanup-VMs -AzureStackHciHostVMs -WindowsAdminCenterVM
Cleanup-VMs -AzureStackHciHostVMs -RedeployDeletedVMs